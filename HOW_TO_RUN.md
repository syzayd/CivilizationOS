...
> Note: Tests require Python 3.11/3.12. NumPy C extensions don't support Python 3.14 yet.

```powershell
# With compatible Python
...
| Tests fail with numpy error | Use Python 3.11/3.12 virtual env, not 3.14 |
